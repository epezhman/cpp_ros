...
{
	std::cout<<"This is filename:"<<filename<<std::endl;
    std::string metaFilename=filename;
   	std::cout<<"This is metaFilename:"<<metaFilename<<std::endl;

    std::ifstream metaFile(metaFilename);
    //std::ifstream metaFile(filename);
    /*std::ifstream metaFile;
    metaFile.open(metaFilename, std::ios_base::in);*/
    std::cout<<"!metaFile="<<!metaFile<<std::endl;
    ...
    // get extents
    Eigen::VectorXi dimSizes(dimensions);
    ...
    // read in data file
  	std::cout<<"This is filename:"<<dataFilename<<std::endl;
...
void MHDHandler::write(const std::string& filename, Volume vol) //If vol is constant it does not work
{
    std::string metaFilename  = filename;
    std::string dataFilename  = filename + ".raw";
